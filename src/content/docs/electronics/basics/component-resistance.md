...
La résistance est un des composants les plus courants des circuits électroniques. Nous en avons légèrement parlé dans "[Les lois fondamentales en régime continu](/electronics/basics/course-basics-fundamental-laws-of-steady-state/)" mais dans cet article, je vais tenter de faire un résumé de tout ce qu'il y a à savoir pour pouvoir utiliser simplement ce composant.
...
Nous avions déjà introduit cette loi dans l'article précédent (cf. "[Les lois fondamentales en régime continu](/electronics/basics/course-basics-fundamental-laws-of-steady-state/)") mais je vais quand même en refaire un rapide résumé.
...
[![Courbe caractéristique d'une résistance](/res/images/Electronique/Composants/Resistance/CourbeCaracteristique.png "Courbe caractéristique d'une résistance")](/res/images/Electronique/Composants/Resistance/CourbeCaracteristique.png)
...
[![Résistance équivalente en série](/res/images/Electronique/Composants/Resistance/ResistancesEnSerie.png "Résistance équivalente en série")](/res/images/Electronique/Composants/Resistance/ResistancesEnSerie.png)
...
[![Résistance équivalente en dérivation](/res/images/Electronique/Composants/Resistance/ResistancesEnDerivation.png "Résistance équivalente en dérivation")](/res/images/Electronique/Composants/Resistance/ResistancesEnDerivation.png)
